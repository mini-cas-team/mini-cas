    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            <div className="flex justify-between items-center mb-6">
                <div>
                    <h2 className="text-2xl font-bold text-gray-900 mb-2">Recommendattion Letters</h2>
                    <p className="text-gray-500">Upload and manage your recommendattion letters (PDF/Word).</p>
                </div>
            ...
            <div className="space-y-3">
                {letters.length === 0 ? (
                    <div className="text-center py-10 text-gray-500 border-2 border-dashed border-gray-200 rounded-xl bg-gray-50/50">
                        No recommendattion letters uploaded yet.
                    </div>
                ) : (
                        ...
                        <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-100 transition-all hover:border-gray-300">
                            <div className="flex items-center gap-4">
                                <a
                                    ...
                                    title="View Recommendattion Letter"
                                >
